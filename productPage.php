...
<div class="container2nd">
    <section class="main">
        <div class="main-top">
            <h1 style="margin-right:10px; margin-left:-30px; margin-top:-40px;">Products</h1>
    ...
    <div class="tableStaff">
        ...
        <table class="table1" style=" margin-top:5px;">
            ...
            if ($categoryFilter) {
                $stmt = $pdo->prepare('SELECT * FROM cafe_product WHERE category_name = :category ORDER BY created_at DESC');
