...
// Check if login was successful and display an alert
if (isset($_GET['login_success']) && $_GET['login_success'] == 1) {
  echo "<script>alert('Logged in!')</script>";
}

// Check if logout was successful, display an alert, and redirect to 'home.php'
...
<div class = "ads">
  <div class = "column">
    <img src="image/coffee.jpg" alt="coffee" style="width:100%">
  </div>
